...
module soc_system_mm_interconnect_0 (
		...
		input  wire        dma_fifo_0_rst_reset_bridge_in_reset_reset,           //     dma_fifo_0_rst_reset_bridge_in_reset.reset
		...
		input  wire [31:0] dma_fifo_0_avalon_master_address,                     //                 dma_fifo_0_avalon_master.address
		output wire        dma_fifo_0_avalon_master_waitrequest,                 //                                         .waitrequest
		input  wire [4:0]  dma_fifo_0_avalon_master_burstcount,                  //                                         .burstcount
		input  wire [3:0]  dma_fifo_0_avalon_master_byteenable,                  //                                         .byteenable
		input  wire        dma_fifo_0_avalon_master_read,                        //                                         .read
		output wire [31:0] dma_fifo_0_avalon_master_readdata,                    //                                         .readdata
		output wire        dma_fifo_0_avalon_master_readdatavalid,               //                                         .readdatavalid
		...
		output wire [3:0]  vga_controller_0_slave_address,                       //                   vga_controller_0_slave.address
		output wire        vga_controller_0_slave_write,                         //                                         .write
		output wire        vga_controller_0_slave_read,                          //                                         .read
		input  wire [31:0] vga_controller_0_slave_readdata,                      //                                         .readdata
		output wire [31:0] vga_controller_0_slave_writedata,                     //                                         .writedata
		output wire [3:0]  vga_controller_0_slave_byteenable,                    //                                         .byteenable
		output wire        vga_controller_0_slave_chipselect                     //                                         .chipselect
	);

	wire          dma_fifo_0_avalon_master_translator_avalon_universal_master_0_waitrequest;          // dma_fifo_0_avalon_master_agent:av_waitrequest -> dma_fifo_0_avalon_master_translator:uav_waitrequest
	wire   [31:0] dma_fifo_0_avalon_master_translator_avalon_universal_master_0_readdata;             // dma_fifo_0_avalon_master_agent:av_readdata -> dma_fifo_0_avalon_master_translator:uav_readdata
	wire          dma_fifo_0_avalon_master_translator_avalon_universal_master_0_debugaccess;          // dma_fifo_0_avalon_master_translator:uav_debugaccess -> dma_fifo_0_avalon_master_agent:av_debugaccess
	wire   [31:0] dma_fifo_0_avalon_master_translator_avalon_universal_master_0_address;              // dma_fifo_0_avalon_master_translator:uav_address -> dma_fifo_0_avalon_master_agent:av_address
	wire          dma_fifo_0_avalon_master_translator_avalon_universal_master_0_read;                 // dma_fifo_0_avalon_master_translator:uav_read -> dma_fifo_0_avalon_master_agent:av_read
	wire    [3:0] dma_fifo_0_avalon_master_translator_avalon_universal_master_0_byteenable;           // dma_fifo_0_avalon_master_translator:uav_byteenable -> dma_fifo_0_avalon_master_agent:av_byteenable
	wire          dma_fifo_0_avalon_master_translator_avalon_universal_master_0_readdatavalid;        // dma_fifo_0_avalon_master_agent:av_readdatavalid -> dma_fifo_0_avalon_master_translator:uav_readdatavalid
	wire          dma_fifo_0_avalon_master_translator_avalon_universal_master_0_lock;                 // dma_fifo_0_avalon_master_translator:uav_lock -> dma_fifo_0_avalon_master_agent:av_lock
	wire          dma_fifo_0_avalon_master_translator_avalon_universal_master_0_write;                // dma_fifo_0_avalon_master_translator:uav_write -> dma_fifo_0_avalon_master_agent:av_write
	wire   [31:0] dma_fifo_0_avalon_master_translator_avalon_universal_master_0_writedata;            // dma_fifo_0_avalon_master_translator:uav_writedata -> dma_fifo_0_avalon_master_agent:av_writedata
	wire    [6:0] dma_fifo_0_avalon_master_translator_avalon_universal_master_0_burstcount;           // dma_fifo_0_avalon_master_translator:uav_burstcount -> dma_fifo_0_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                  // rsp_mux:src_valid -> dma_fifo_0_avalon_master_agent:rp_valid
	wire  [113:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> dma_fifo_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                  // dma_fifo_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> dma_fifo_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                          // rsp_mux:src_startofpacket -> dma_fifo_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                            // rsp_mux:src_endofpacket -> dma_fifo_0_avalon_master_agent:rp_endofpacket
	...
	wire   [31:0] vga_controller_0_slave_agent_m0_readdata;                                           // vga_controller_0_slave_translator:uav_readdata -> vga_controller_0_slave_agent:m0_readdata
	wire          vga_controller_0_slave_agent_m0_waitrequest;                                        // vga_controller_0_slave_translator:uav_waitrequest -> vga_controller_0_slave_agent:m0_waitrequest
	wire          vga_controller_0_slave_agent_m0_debugaccess;                                        // vga_controller_0_slave_agent:m0_debugaccess -> vga_controller_0_slave_translator:uav_debugaccess
	wire   [31:0] vga_controller_0_slave_agent_m0_address;                                            // vga_controller_0_slave_agent:m0_address -> vga_controller_0_slave_translator:uav_address
	wire    [3:0] vga_controller_0_slave_agent_m0_byteenable;                                         // vga_controller_0_slave_agent:m0_byteenable -> vga_controller_0_slave_translator:uav_byteenable
	wire          vga_controller_0_slave_agent_m0_read;                                               // vga_controller_0_slave_agent:m0_read -> vga_controller_0_slave_translator:uav_read
	wire          vga_controller_0_slave_agent_m0_readdatavalid;                                      // vga_controller_0_slave_translator:uav_readdatavalid -> vga_controller_0_slave_agent:m0_readdatavalid
	wire          vga_controller_0_slave_agent_m0_lock;                                               // vga_controller_0_slave_agent:m0_lock -> vga_controller_0_slave_translator:uav_lock
	wire   [31:0] vga_controller_0_slave_agent_m0_writedata;                                          // vga_controller_0_slave_agent:m0_writedata -> vga_controller_0_slave_translator:uav_writedata
	wire          vga_controller_0_slave_agent_m0_write;                                              // vga_controller_0_slave_agent:m0_write -> vga_controller_0_slave_translator:uav_write
	wire    [2:0] vga_controller_0_slave_agent_m0_burstcount;                                         // vga_controller_0_slave_agent:m0_burstcount -> vga_controller_0_slave_translator:uav_burstcount
	wire          vga_controller_0_slave_agent_rf_source_valid;                                       // vga_controller_0_slave_agent:rf_source_valid -> vga_controller_0_slave_agent_rsp_fifo:in_valid
	wire  [114:0] vga_controller_0_slave_agent_rf_source_data;                                        // vga_controller_0_slave_agent:rf_source_data -> vga_controller_0_slave_agent_rsp_fifo:in_data
	wire          vga_controller_0_slave_agent_rf_source_ready;                                       // vga_controller_0_slave_agent_rsp_fifo:in_ready -> vga_controller_0_slave_agent:rf_source_ready
	wire          vga_controller_0_slave_agent_rf_source_startofpacket;                               // vga_controller_0_slave_agent:rf_source_startofpacket -> vga_controller_0_slave_agent_rsp_fifo:in_startofpacket
	wire          vga_controller_0_slave_agent_rf_source_endofpacket;                                 // vga_controller_0_slave_agent:rf_source_endofpacket -> vga_controller_0_slave_agent_rsp_fifo:in_endofpacket
	wire          vga_controller_0_slave_agent_rsp_fifo_out_valid;                                    // vga_controller_0_slave_agent_rsp_fifo:out_valid -> vga_controller_0_slave_agent:rf_sink_valid
	wire  [114:0] vga_controller_0_slave_agent_rsp_fifo_out_data;                                     // vga_controller_0_slave_agent_rsp_fifo:out_data -> vga_controller_0_slave_agent:rf_sink_data
	wire          vga_controller_0_slave_agent_rsp_fifo_out_ready;                                    // vga_controller_0_slave_agent:rf_sink_ready -> vga_controller_0_slave_agent_rsp_fifo:out_ready
	wire          vga_controller_0_slave_agent_rsp_fifo_out_startofpacket;                            // vga_controller_0_slave_agent_rsp_fifo:out_startofpacket -> vga_controller_0_slave_agent:rf_sink_startofpacket
	wire          vga_controller_0_slave_agent_rsp_fifo_out_endofpacket;                              // vga_controller_0_slave_agent_rsp_fifo:out_endofpacket -> vga_controller_0_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> vga_controller_0_slave_agent:cp_valid
	wire  [113:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> vga_controller_0_slave_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // vga_controller_0_slave_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> vga_controller_0_slave_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> vga_controller_0_slave_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> vga_controller_0_slave_agent:cp_endofpacket
	wire          dma_fifo_0_avalon_master_agent_cp_valid;                                            // dma_fifo_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [113:0] dma_fifo_0_avalon_master_agent_cp_data;                                             // dma_fifo_0_avalon_master_agent:cp_data -> router:sink_data
	wire          dma_fifo_0_avalon_master_agent_cp_ready;                                            // router:sink_ready -> dma_fifo_0_avalon_master_agent:cp_ready
	wire          dma_fifo_0_avalon_master_agent_cp_startofpacket;                                    // dma_fifo_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          dma_fifo_0_avalon_master_agent_cp_endofpacket;                                      // dma_fifo_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          vga_controller_0_slave_agent_rp_valid;                                              // vga_controller_0_slave_agent:rp_valid -> router_008:sink_valid
	wire  [113:0] vga_controller_0_slave_agent_rp_data;                                               // vga_controller_0_slave_agent:rp_data -> router_008:sink_data
	wire          vga_controller_0_slave_agent_rp_ready;                                              // router_008:sink_ready -> vga_controller_0_slave_agent:rp_ready
	wire          vga_controller_0_slave_agent_rp_startofpacket;                                      // vga_controller_0_slave_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          vga_controller_0_slave_agent_rp_endofpacket;                                        // vga_controller_0_slave_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          vga_controller_0_slave_agent_rdata_fifo_src_valid;                                  // vga_controller_0_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] vga_controller_0_slave_agent_rdata_fifo_src_data;                                   // vga_controller_0_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          vga_controller_0_slave_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_005:in_0_ready -> vga_controller_0_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> vga_controller_0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> vga_controller_0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // vga_controller_0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> vga_controller_0_slave_agent:rdata_fifo_sink_error
	...
	) dma_fifo_0_avalon_master_translator (
		.clk                    (clk_0_clk_clk),                                                               //                       clk.clk
		.reset                  (dma_fifo_0_rst_reset_bridge_in_reset_reset),                                  //                     reset.reset
		.uav_address            (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (dma_fifo_0_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (dma_fifo_0_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (dma_fifo_0_avalon_master_burstcount),                                         //                          .burstcount
		.av_byteenable          (dma_fifo_0_avalon_master_byteenable),                                         //                          .byteenable
		.av_read                (dma_fifo_0_avalon_master_read),                                               //                          .read
		.av_readdata            (dma_fifo_0_avalon_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (dma_fifo_0_avalon_master_readdatavalid),                                      //                          .readdatavalid
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) vga_controller_0_slave_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (dma_fifo_0_rst_reset_bridge_in_reset_reset),    //                    reset.reset
		.uav_address            (vga_controller_0_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (vga_controller_0_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (vga_controller_0_slave_agent_m0_read),          //                         .read
		.uav_write              (vga_controller_0_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (vga_controller_0_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (vga_controller_0_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (vga_controller_0_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (vga_controller_0_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (vga_controller_0_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (vga_controller_0_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (vga_controller_0_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (vga_controller_0_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (vga_controller_0_slave_write),                  //                         .write
		.av_read                (vga_controller_0_slave_read),                   //                         .read
		.av_readdata            (vga_controller_0_slave_readdata),               //                         .readdata
		.av_writedata           (vga_controller_0_slave_writedata),              //                         .writedata
		.av_byteenable          (vga_controller_0_slave_byteenable),             //                         .byteenable
		.av_chipselect          (vga_controller_0_slave_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
		.av_readdatavalid       (1'b0),                                          //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) dma_fifo_0_avalon_master_agent (
		.clk                   (clk_0_clk_clk),                                                               //       clk.clk
		.reset                 (dma_fifo_0_rst_reset_bridge_in_reset_reset),                                  // clk_reset.reset
		.av_address            (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (dma_fifo_0_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (dma_fifo_0_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (dma_fifo_0_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (dma_fifo_0_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (dma_fifo_0_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (dma_fifo_0_avalon_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) vga_controller_0_slave_agent (
		.clk                     (clk_0_clk_clk),                                           //             clk.clk
		.reset                   (dma_fifo_0_rst_reset_bridge_in_reset_reset),              //       clk_reset.reset
		.m0_address              (vga_controller_0_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (vga_controller_0_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (vga_controller_0_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (vga_controller_0_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (vga_controller_0_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (vga_controller_0_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (vga_controller_0_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (vga_controller_0_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (vga_controller_0_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (vga_controller_0_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (vga_controller_0_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (vga_controller_0_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (vga_controller_0_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (vga_controller_0_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (vga_controller_0_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (vga_controller_0_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (vga_controller_0_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (vga_controller_0_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (vga_controller_0_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (vga_controller_0_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (vga_controller_0_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (vga_controller_0_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (vga_controller_0_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (vga_controller_0_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (vga_controller_0_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (vga_controller_0_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                       //                .error
		.rdata_fifo_src_ready    (vga_controller_0_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (vga_controller_0_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (vga_controller_0_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                   //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                     //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) vga_controller_0_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                           //       clk.clk
		.reset             (dma_fifo_0_rst_reset_bridge_in_reset_reset),              // clk_reset.reset
		.in_data           (vga_controller_0_slave_agent_rf_source_data),             //        in.data
		.in_valid          (vga_controller_0_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (vga_controller_0_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (vga_controller_0_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (vga_controller_0_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (vga_controller_0_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (vga_controller_0_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (vga_controller_0_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (vga_controller_0_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (vga_controller_0_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                   // (terminated)
		.csr_read          (1'b0),                                                    // (terminated)
		.csr_write         (1'b0),                                                    // (terminated)
		.csr_readdata      (),                                                        // (terminated)
	...
	soc_system_mm_interconnect_0_router router (
		.sink_ready         (dma_fifo_0_avalon_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (dma_fifo_0_avalon_master_agent_cp_valid),         //          .valid
		.sink_data          (dma_fifo_0_avalon_master_agent_cp_data),          //          .data
		.sink_startofpacket (dma_fifo_0_avalon_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (dma_fifo_0_avalon_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                   //       clk.clk
		.reset              (dma_fifo_0_rst_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	soc_system_mm_interconnect_0_router_004 router_008 (
		.sink_ready         (vga_controller_0_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (vga_controller_0_slave_agent_rp_valid),         //          .valid
		.sink_data          (vga_controller_0_slave_agent_rp_data),          //          .data
		.sink_startofpacket (vga_controller_0_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (vga_controller_0_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (dma_fifo_0_rst_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                     // in_clk_0.clk
		.in_rst_0_reset (dma_fifo_0_rst_reset_bridge_in_reset_reset),        // in_rst_0.reset
		.in_0_data      (vga_controller_0_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (vga_controller_0_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (vga_controller_0_slave_agent_rdata_fifo_src_ready), //         .ready
